...
def init_ata_router(get_current_user, has_perm, require_perm, audit_log):
...
async def ata_summary(request: Request, company: str = "RM"):
...
async def invoicing_queue(request: Request, company: str = "RM"):
